...
var num2 = $('.wudi').eq(1).offset().top
var num3 = $('.wudi').eq(2).offset().top - 1
var num4 = $('.wudi').eq(3).offset().top - 1
function move() {
    $('.page-container div').removeClass('show')
    if ($(document).scrollTop() < num2) {
        $('.page-container li').eq(0).children('div').show()
        $('.page-container li').eq(0).siblings().children('div').hide()
    } else if ($(document).scrollTop() >= num2 && $(document).scrollTop() < num3) {
        $('.page-container li').eq(1).children('div').show()
        $('.page-container li').eq(1).siblings().children('div').hide()
    } else if ($(document).scrollTop() >= num3 && $(document).scrollTop() < num4) {
        $('.page-container li').eq(2).children('div').show()
        $('.page-container li').eq(2).siblings().children('div').hide()
    } else if ($(document).scrollTop() > num4) {
        $('.page-container li').eq(3).children('div').show()
        $('.page-container li').eq(3).siblings().children('div').hide()
    }
}
move();
